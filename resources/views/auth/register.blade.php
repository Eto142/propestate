...
<head>
    <meta charset="utf-8" />
    <title>StandardOptions | Register</title>
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-4" >
                                    ...
                                    <p style="color: white">Get your free StandardOptions account now.</p>
                                </div>
                            </div>
                          ...
                          <form method="POST" action="{{ route('register') }}" id="regester" class="needs-validation" novalidate>
                            ...
                            @enderror
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the StandardOptions.net <a href="#" class="text-primary">Terms of Use</a></p>
                                <br>
...
<a href="mailto:'support@standardoptions.net'"><img src="emailpng.png" class="feedback" alt="email"/></a>
</div>
        <style>
         .feedback {
             width:62px;
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ©
                            ...
                            <i class="bx bx-check-shield text-success"></i>StandardOptions</p>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $('#regester').on('submit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "https://StandardOptions.net/custom-registration",
                data: $(this).serialize(),
                dataType: "json",
