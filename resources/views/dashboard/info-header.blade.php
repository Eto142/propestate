<!DOCTYPE html>
<html class="Page homepage" lang="en-US"
>

<!-- Mirrored from www.realtymogul.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 Aug 2024 23:04:27 GMT -->
...
body {
  ...
  --font-2: "superior-title";
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5"><title>RealtyMogul.com™ | Real Estate Crowdfunding &amp; Investing</title><meta name="description" content="RealtyMogul simplifies commercial real estate investing. Explore select real estate opportunities.
Go beyond stocks and bonds."><link rel="canonical" href="index.html"><meta name="brightspot.contentId" content="00000182-b73e-d57d-a5ab-ff7eab3a0000"><link rel="apple-touch-icon"sizes="180x180"href="apple-touch-icon.png"><link rel="icon"type="image/png"href="favicon-32x32.png"><link rel="icon"type="image/png"href="favicon-16x16.png"><link type="application/rss+xml" rel="alternate" title="RealtyMogul.com™ | Real Estate Crowdfunding & Investing" href="index.rss"><script type="application/ld+json">{"@context":"http://schema.org","@type":"WebPage","potentialAction":{"@context":"http://schema.org","@type":"SearchAction","query-input":"required name=search_term_string","target":{"@type":"EntryPoint","urlTemplate":"https://www.realtymogul.com/search?q={search_term_string}"}},"url":"https://www.realtymogul.com/","description":"RealtyMogul simplifies commercial real estate investing. Explore select real estate opportunities.\nGo beyond stocks and bonds.","publisher":{"@type":"Organization","name":"RealtyMogul","logo":{"@type":"ImageObject","url":"https://realtymogul.brightspotgocdn.com/9d/35/a0265c0e416da16bebfc628b4626/logo-stacked-black.ca6b1bab.svg"}},"name":"RealtyMogul.com™ | Real Estate Crowdfunding & Investing"}</script>
    ...
    <script>
        ...
        */
        ...
        if (!window.CSS || !window.CSS.supports || !window.CSS.supports('--fake-var', 0)) {
            ...
            <script src="realtymogul.brightspotgocdn.com/resource/00000191-2449-dcb8-a7f5-3e4b6ab70000/styles/default/Homepage.min.7c0925de3175904fa89400c1b0bd2ac6.gz.js" async></script>
...
<bsp-header class="Page-header">
    ...
    <div class="MobileNavigationItem-text" data-toggle-trigger="navigation-item">
      <a class="MobileNavigationItem-text-link" href="{{url('investment')}}" data-cms-ai="0">
                    <span class="MobileNavigationItem-text-link-label">Investment</span>
                    <span class="MobileNavigationItem-text-active"><svg><use href="#new-checkmark"></use></svg></span></a></div></bsp-toggler>
</li>


<li class="MobileNavigation-items-item"><bsp-toggler class="MobileNavigationItem" data-toggle="navigation-item">
    <div class="MobileNavigationItem-text" data-toggle-trigger="navigation-item"><a class="MobileNavigationItem-text-link" href="{{url('why-reit')}}" data-cms-ai="0">
            ...
            <ul class="MobileNavigationItem-items"><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('income-reit')}}" data-cms-ai="0">
...
</li><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('growth-reit')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Growth REIT</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('why-reit')}}" data-cms-ai="0">
  ...
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    ...
    <div class="MobileNavigationItem-text" data-toggle-trigger="navigation-item"><a class="MobileNavigationItem-text-link" href="{{url('investment-option')}}" data-cms-ai="0">
                    <span class="MobileNavigationItem-text-link-label"> Research</span>
                    <span class="MobileNavigationItem-text-active"><svg><use href="#new-checkmark"></use></svg></span><div class="MobileNavigationItem-more">
                            <button aria-label="Open Sub Navigation"><svg class="chevron-down"><use href="#blue-caret"></use></svg></button>
                        </div></a></div><div class="MobileNavigationItem-items-container">
            <ul class="MobileNavigationItem-items"><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('track-record')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Track Record</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('past-investments')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Past Investments</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('due-diligence-process')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Due Diligence Process</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('investment-option')}}" data-cms-ai="0">
...
<li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('commercial-real-estates')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Why Commercial Real Estate</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="MobileNavigationItem-items-item"><a class="NavigationLink" href="{{url('knowledge-centers')}}" data-cms-ai="0">
  ...
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    ...
    <div class="MobileNavigation-unauthenticated">
        ...
        <bsp-auth-button><a class="Page-header-signInBtn NotButton AuthButton" data-size="default"  href="#signIn" data-cms-ai="0">Sign in</a></bsp-auth-button>
    ...
    <div class="Page-header-account-menu">
        <div class="MobileNavigation-authenticated">
            ...
            <div class="MobileNavigationItem-authenticated-items-container">
                <a class="NavigationLink" href="" data-cms-ai="0"><span class="NavigationLink-text">Dashboard</span></a>
                <a class="NavigationLink messages" href="" data-cms-ai="0"><span class="NavigationLink-text">Messages</span><span class="messages-count"></span></a>
                <a class="NavigationLink" href="" data-cms-ai="0"><span class="NavigationLink-text">My Profile</span></a>
...
<li class="Navigation-items-item"><bsp-navigation-item class="NavigationItem">
    <div class="NavigationItem-text"><a class="NavigationItem-text-link" href="{{url('why-reit')}}" data-cms-ai="0">
            ...
            </div></div><div class="NavigationItem-items-container"  ><ul class="NavigationItem-items"><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('income-reit')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Income REIT</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('growth-reit')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Growth REIT</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('why-reit')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Why REITS</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
...
<li class="Navigation-items-item"><bsp-navigation-item class="NavigationItem">
    <div class="NavigationItem-text"><a class="NavigationItem-text-link" href="{{url('investment-option')}}" data-cms-ai="0">
                    <span class="NavigationItem-text-link-label"> Research</span>
                </a><div class="NavigationItem-more">
                <button aria-label="Open Sub Navigation"><svg class="chevron-down"><use href="#chevron-up-nav"></use></svg></button>
            </div></div><div class="NavigationItem-items-container"  ><ul class="NavigationItem-items"><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('track-record')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Track Record</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('past-investments')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Past Investments</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('due-diligence-process')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Due Diligence Process</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('investment-option')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Investment Options</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li>
...
<li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('commercial-real-estates')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Why Commercial Real Estate</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li><li class="NavigationItem-items-item" ><a class="NavigationLink" href="{{url('knowledge-centers')}}" data-cms-ai="0">
  <span class="NavigationLink-text">Knowledge Center</span>
  <span class="NavigationLink-active"><svg class="icon-checkmark"><use href="#icon-checkmark"></use></svg></span>
    </a>
</li></ul></div></bsp-navigation-item>
...
<li class="Navigation-items-item"><bsp-navigation-item class="NavigationItem">
  <div class="NavigationItem-text"><a class="NavigationItem-text-link" href="{{url('')}}" data-cms-ai="0">
                  <span class="NavigationItem-text-link-label"> Our Story</span>
              </a><div class="NavigationItem-more">
...
<li class="Navigation-items-item" data-overflow-trigger><bsp-navigation-item class="NavigationItem">
    ...
    <nav>
        <ul class="Navigation-items">
            ...
            <div class="Page-header-unauthenticated">
                <bsp-auth-button><a class="Page-header-signInBtn NotButton AuthButton" data-size="default"  href="#signIn" >Sign in</a></bsp-auth-button>
