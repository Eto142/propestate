...
<div class="container">
 ...
 @if(Auth::user()->bot_status=='1')
  ...
  SO Protect Activated Sucessfully!
  	
  	 @else
 

  
 SO Protect not activated yet, please Activate!
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h5 class="modal-title">Please deposit the fixed price of $3500 to purchase SO Protect.</h5>
        </div>
 ...
 <input type="submit" name="submit" value="submit">
  ...
  // resources/js/app.js
    ...
    function showAlert() {
        Swal.fire({
            title: "To Activate SO Protect Deposit $3500",
