    ...
    <style>
      ...
      >
        ...
        <div class="sc-bxivhb VUgHi" width="100%" display="flex">
          ...
          <div class="sc-bxivhb frlJDJ" width="100%" display="flex,none">
            <div
              ...
              cursor="pointer"
              >
                <bsp-toggler class="MobileNavigationItem" data-toggle="navigation-item">
                  <div
                    class="MobileNavigationItem-text"
                    data-toggle-trigger="navigation-item"
                    >
                    <div
                      class="sc-bxivhb ihfEDg"
                      border="1px solid #176DB6"
                      p="10px"
                      width="100%"
                      color="#176DB6"
                      ...
                      >
                        <a
                          class="MobileNavigationItem-text-link"
                          href="{{url('profile')}}"
                          data-cms-ai="0"
                          style="width: 100%; -webkit-align-items: center; -webkit-box-align: center; color: #176DB6"
                        >
                          <span class="MobileNavigationItem-text-link-label" style="padding-right: 40px;"
                            >Investments</span
                          >
                          <img
                            class="sc-iwsKbI iYdxMO"
                            src="https://cdn.realtymogul.com/static/media/down_blue.e95e94b9.svg"
                          />
                        </a>
                      </div>
                  ...
                  <div class="MobileNavigationItem-items-container" style="background: #FFFFFF; width: 93%; border: 1px solid #176DB6;">
                    <ul class="MobileNavigationItem-items" style="background: white; position: relative; z-index: 1;">
                      <li class="MobileNavigationItem-items-item">
                        <a
                          class="NavigationLink"
                          href="{{url('active-investments')}}"
                          data-cms-ai="0"
                          ><span class="NavigationLink-text" style="color: #176DB6"
                            >Investments</span
                          ></a
                        >
                      </li>
        ...
        >
          ...
          ><a
            class="sc-kgoBCf gztDAg active"
            font-family="sansSerif"
            text-decoration="none"
            href="{{url('completed-investments')}}"
            >COMPLETED INVESTMENTS</a
          ><a
            class="sc-kgoBCf jQthOg"
            font-family="sansSerif"
            text-decoration="none"
            href="{{url('pending-investments')}}"
        ...
        <div class="financial-summary">
          <section class="card">
              <div class="card-content">
                  <p class="amount">${{$user_balance}}</p>
                  <i class="fas fa-chart-line icon"></i>
                  <p class="description">TOTAL INVESTED - ACTIVE</p>
              </div>
          </section>
      
          <section class="card">
              <div class="card-content">
                  <p class="amount">${{$earning}}</p>
                  <i class="fas fa-dollar-sign icon"></i>
                  <p class="description">TOTAL DISTRIBUTIONS - ACTIVE</p>
              </div>
          </section>
      </div>
...
<div
style="position: relative; height: 40vh; display: flex; width: 80%; font-size: 26px; margin-bottom: -17%; font-family: 'Mrs Eaves XL Serif Narrow', serif;"
>
<p
  style="font-size: 26px; font-weight: normal; letter-spacing: 0.131em; color: black;"
>
  Completed Investments
       ...
       <style>
        ...
        .header__item {
            ...
            font-weight: 700;
            color: black;
            border-right: 1px solid #b8b8b8; /* Adds a border between columns */
        }
        ...
        @media (max-width: 768px) {
            ...
            .header__item {
                padding: 8px;
                border-right: 1px solid #b8b8b8; /* Ensure there is space between items */
            }
...
<body>
    <div style="width: 100%; margin-bottom: 11%; z-index: 1; margin-top: 3%">
        <div class="container">
            <div class="table">
                <div class="table-header">
                    <div class="header__item"><a id="wins" class="filter__link filter__link--number">Investments</a></div>
                    <div class="header__item"><a id="draws" class="filter__link filter__link--number">Duration</a></div>
                    <div class="header__item"><a id="losses" class="filter__link filter__link--number">Amount</a></div>
                    <div class="header__item"><a id="totall" class="filter__link filter__link--number">Time</a></div>
                    <div class="header__item"><a id="total" class="filter__link filter__link--number">Status</a></div>
                </div>
                <p class="message">No completed investment yet</p>
            </div>
        </div>
    </div>
        ...
        <!-- <div style="width: 100%; height: 4rem; background: red; padding:9px">
          <div style="width: 80rem; height: 9rem; background: orange;">
          </div>
        </div> -->
