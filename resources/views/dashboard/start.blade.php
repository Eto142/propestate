@include('dashboard.info-header')

<!DOCTYPE html>
<html class="Page" lang="en" data-page-fullwidth="true">

<!-- Mirrored from www.realtymogul.com/investment-opportunities by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Nov 2022 00:59:30 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <link data-cssvarsponyfill="true" class="Webpack-css" rel="stylesheet"
    href="realtymogul.brightspotgocdn.com/resource/00000191-2449-dcb8-a7f5-3e4b6ab70000/styles/default/All.min.1bcc391483370c98cc8b3d7e43b39ba0.gz.css">

  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5">
  <title>PropertiesInvestmentProgram.com™ | Real Estate Crowdfunding &amp; Investing</title>
            ...
            <form method="POST" action="{{route('update.start')}}">
              @csrf
                <div class="progress-bar">
                    <div class="current">Investor Info</div>
                    <div class="faded">Suitability</div>
                    <div class="faded">Sign & Fund</div>
                </div>
        
                <h2>Get Started</h2>
                <h3>Contact Information</h3>
                <p>Please provide your contact information below should we need to contact you about this investment.</p>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="last-name" name="lname" {{Auth::user()->lname}}>
                    </div>
                </div>
        
                <div class="form-group">
                    <label for="phone">Phone Number</label>
                    <input type="tel" id="phone" name="phone" {{Auth::user()->phone}}>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="zip" name="pcode" value="{{Auth::user()->pcode}}">
                    </div>
                </div>
