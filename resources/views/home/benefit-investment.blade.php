...
<!-- Mirrored from PropEstateHoldings.com/src/benefits-of-investing.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Aug 2024 14:43:15 GMT -->
...
<head>
    ...
    <style>
        .PagePromoA-investmentName .Tooltip br {
            height: 0;
            display: none;
        }
    </style>
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5">
    <title>PropEstateHoldings.com™ | Your Money Deserves More</title>
    ...
    <script
        src="../realtymogul.brightspotgocdn.com/resource/00000184-315e-d691-a1be-7ffff7bd0000/styles/default/All.min.2275d1811a555e8c92d591f421fabc97.gz.js"
        async></script>
    <script type="text/javascript" defer
        src="../static.zdassets.com/ekr/snippeta6cda6cd.js?key=f0fb7231-d555-4b6c-b382-06ff3c2efb4e"
    ...
    <div class="Page-content" style="min-height: 100vh">
        ...
        <div class="Page-pageLead" data-pagelead>
            <div class="PageHeading"
                style="--opacityOverlay: 40%; background-color:var(--color-callout-bg); --color-heading-text:#ffffff;background-image: url('../../realtymogul.brightspotgocdn.com/dims4/default/20c7a0e/2147483647/strip/true/crop/1920x480%2b0%2b100/resize/1440x360%21/quality/90/indexd062.html?url=https%3A%2F%2Fbrightspot-go-k1-realtymogul.s3.amazonaws.com%2Fbrightspot%2F84%2F4e%2F54c111b84c56a34a5c75affed712%2Fboi-hero.f1153c32.jpg');"
                data-text-align="center" data-with-bg>
                <div class="PageHeading-content-wrapper">
                    <div class="PageHeading-content">



                        <h1 class="PageHeading-title">Your Money Deserves More</h1>


                        <div class="PageHeading-divider"></div>
                        <h2 class="PageHeading-subHeading">Commercial Real Estate Can Augment Your Investing Strategy
                        </h2>
                ...
                <nav class="SectionNavigation-wrapper">
                    ...
                    <ul class="SectionNavigation-items">
                        ...
                        <li class="SectionNavigation-items-item">
                            <div class="SectionNavigationItem">
                                <div class="SectionNavigationItem-text">
                                    <a class="Link" href="#adding-passive-income-to-your-portfolio" data-cms-ai="0">EARN
                                        PASSIVE INCOME</a>
                                </div>
                            </div>
                        ...
                        <li class="SectionNavigation-items-item">
                            <div class="SectionNavigationItem">
                                <div class="SectionNavigationItem-text">
                                    <a class="Link" href="#a-strategy-to-grow-wealth" data-cms-ai="0">GROW VALUE</a>
                                </div>
                            </div>
                        ...
                        <li class="SectionNavigation-items-item">
                            <div class="SectionNavigationItem">
                                <div class="SectionNavigationItem-text">
                                    <a class="Link" href="#create-a-diversified-portfolio" data-cms-ai="0">DIVERSIFY
                                        YOUR HOLDINGS</a>
                                </div>
                            </div>
                    ...
                    <div class="SectionNavigation-select">
                        ...
                        <div class="SectionNavigation-select-menu-outer">
                            <div class="SectionNavigation-select-menu" role="listbox" tabindex="-1">
                                ...
                                <a class="SectionNavigation-select-menu-option" role="option"
                                    aria-label="EARN PASSIVE INCOME" href="#adding-passive-income-to-your-portfolio"
                                    data-cms-ai="0">EARN PASSIVE INCOME</a>

                                <a class="SectionNavigation-select-menu-option" role="option" aria-label="GROW VALUE"
                                    href="#a-strategy-to-grow-wealth" data-cms-ai="0">GROW VALUE</a>

                                <a class="SectionNavigation-select-menu-option" role="option"
                                    aria-label="DIVERSIFY YOUR HOLDINGS" href="#create-a-diversified-portfolio"
                                    data-cms-ai="0">DIVERSIFY YOUR HOLDINGS</a>
        ...
        <main class="Page-oneColumn" data-modulewell>
            <div class="PagePromoModuleL" data-has-background
                style="--color-module-background:#f2f2f2;  --opacityOverlay: 0%;" data-image-position="right">

                <a class="AnchorLink" id="adding-passive-income-to-your-portfolio"
                    name="adding-passive-income-to-your-portfolio" data-cms-ai="0"></a>
                ...
                <div class="PagePromo-media"><span class="Link">
                        <picture>
                            <source type="image/webp" width="1440" height="810"
                                srcset="./assets/images/1.png 1x,./assets/images/1.png 2x" />

                            <source width="1440" height="810"
                                srcset="assets/images/1.png" />

                            <img class="Image" data-image-size="xl-16x9" alt="ReplaceBENEFITSimage.jpg" width="1440"
                                height="810"
                                srcset="./assets/images/1.png 1x,./assets/images/1.png 2x"
                ...
                <div class="PagePromoModuleL-content-wrapper" style="display: block;">
                    <div class="PagePromoModuleL-content">
                        ...
                        <div class="PagePromo-description" data-animate="fade">
                            <div class="cms-textAlign-left">Passive income is exactly what it sounds like: periodic
                                disbursements without significant effort beyond your initial investment.</div><br>
                            <div class="cms-textAlign-left"></div>
                            <div class="cms-textAlign-left">While real estate has traditionally been considered a
                                passive investment strategy, actively owning rental properties generally requires
                                considerable effort, including overseeing the purchase, performing inspections, finding
                                tenants and ongoing property management and maintenance.</div><br>
                            <div class="cms-textAlign-left"></div>
                            <div class="cms-textAlign-left">On the PropEstateHoldings platform, investors can invest in a
                                variety of commercial real estate deals located across the country. The real estate
                                companies manage the properties for you, providing a truly passive real estate investing
                                experience.</div>
                        </div>
            ...
            <div class="PageListStandardV" data-module data-has-background style="--color-module-background:#f8f8f8;"
                data-column-count="2">
                ...
                <div class="PageList-header" data-auth-type="Join">
                    ...
                    <div class="PageList-header-title" data-animate="fade">Passive Income Opportunities Available Today
                    </div>
                            ...
                            <div class="PagePromoA-container">
                                <div class="PagePromoA-top">
                                    ...
                                    <div class="PagePromoA-image">
                                        ...
                                        <a class="Link" aria-label="THE INCOME REIT"
                                            href="{{url('income-reit')}}" data-cms-ai="0">
                                            <picture>
                                                <source type="image/webp" width="1000" height="563"
                                                    srcset="./assets/images/income.png 1x,./assets/images/income.png 2x" />

                                                <source width="1000" height="563"
                                                    srcset="assets/images/income.png" />
                                                    
                                                <img class="Image" data-image-size="large-16x9" alt="MRI.81683e57.jpg"
                                ...
                                <div class="PagePromoA-bottom">
                                        ...
                                        <div>
                                            ...
                                            <bsp-tooltip class="Tooltip">
                                                ...
                                                <template style="display: none;">
                                                    ...
                                                    <div class="Tooltip-body">PropEstateHoldings Income REIT has consistently
                                                        declared distributions on a monthly basis since it started its
                                                        operation. All distributions equate to approximately 6.00% (net
                                                        of fees) on an annualized basis based upon Purchase Price and
                                                        Net Asset Value (NAV) as of 04/30/20. The annualized
                                                        distribution rate is not a guarantee or projection of future
                                                        distributions and may be modified at the REIT's discretion.
                                                    </div>
                                    ...
                                    <div class="R-IOPromo-distributionFrequency io-flex-block" data-animate="fade">
                                        <div>
                                            ...
                                            <bsp-tooltip class="Tooltip">
                                                ...
                                                <template style="display: none;">
                                                    ...
                                                    <div class="Tooltip-body">The frequency with which you can expect to
                                                        receive distributions. Distributions may be automatically
                                                        reinvested or deposited to a bank account. Distributions are not
                                                        guaranteed.</div>
                                        ...
                                        <div class="R-IOPromo-distributionFrequency-value io-bold-value io-value">
                                            Monthly</div>
                                    </div>
                                    ...
                                    <div class="PagePromoA-blurb-container">
                                        ...
                                        <div class="PagePromoA-blurb">
                                            A Real Estate Investment Trust with the objectives to pay attractive and
                                            consistent cash distributions; and to preserve, protect, increase and return
                                    ...
                                    <div class="PagePromo-button" data-animate="fade">
                                        ...
                                        <a class="Button" data-size="small"
                                            href="{{url('income-reit')}}" data-cms-ai="0">View
                                            Details</a>
                            ...
                            <div class="PagePromoA-container">
                                <div class="PagePromoA-top">
                                    ...
                                    <div class="PagePromoA-image">
                                        ...
                                        <picture>
                                            <source type="image/webp" width="1000" height="563"
                                                srcset="./assets/images/private_placement.png 1x,./assets/images/private_placement.png 2x" />

                                            <source width="1000" height="563"
                                                srcset="assets/images/private_placement.png" />

                                            <img class="Image" data-image-size="large-16x9"
                                                alt="img_card_locked.47aa9929.jpg" width="1000" height="563"
                                                srcset="./assets/images/private_placement.png 1x,./assets/images/private_placement.png 2x"
                                                src="assets/images/private_placement.png"
                                                loading="lazy">
                                        </picture>
                                    </div>
                                </div>
                                <div class="PagePromoA-middle">
                                    <div class="PagePromoA-propertyLocation">PRIVATE PLACEMENTS</div>
                                    <div class="PagePromoA-investmentName">
                                        <bsp-tooltip class="Tooltip">
                                            <button type="button">
                                            ...
                                            <div class="Tooltip-container" data-tippy-root></div>
                                            <template style="display: none;">
                                                <div class="Tooltip-body">An Accredited investor meets at least one of
                                                    the following criteria:<br /><br />
                                                    <ul>
                                                        <li>Net Worth in excess of $1 million (individually or jointly),
                                                            excluding the value of your primary residence.</li>
                                                        <li>Income in excess of $200,000 for this year and in the
                                                            previous two years, with the expectation of maintaining such
                                                            level of income in the future.</li>
                                                        <li>Joint Income in excess of $300,000 for this year and the
                                                            previous two years, with the expectation of maintaining such
                                                            level of income in the future (Note: it is not mandatory to
                                                            qualify jointly with your spouse if you qualify as an
                                                            individual.</li>
                                                    </ul>
                                                </div>
                                            </template>
                                ...
                                <div class="PagePromoA-bottom">
                                    ...
                                    <div class="R-IOPromo-minimumInvestment io-flex-block" data-animate="fade">
                                        ...
                                        <div class="R-IOPromo-minimumInvestment-value io-bold-value io-value">Varied
                                        </div>
                                    </div>
                                    <div class="R-IOPromo-targetHold io-flex-block" data-animate="fade">
                                        <div>
                                            Target Hold
                                        </div>
                                        <div class="R-IOPromo-targetHold-value io-bold-value io-value">Varied</div>
                                    </div>
                                    <div class="R-IOPromo-propertyType io-flex-block" data-animate="fade">
                                        <div>
                                            Property Type
                                        </div>
                                        <div class="R-IOPromo-propertyType-value io-bold-value io-value">Varied</div>
                                    </div>
                                    <div class="PagePromoA-blurb-container">

                                        <div class="PagePromoA-blurb">
                                            Individual properties fully vetted with the investment objective of capital
                                            appreciation and income. Apply for access to Private Placements during
                                            registration.
                                        </div>
                                    ...
                                    <div class="PagePromo-button" data-auth-type="Join" data-animate="fade">
                                                    ...
                                                    <bsp-auth-button>
                                                        <a class="JoinAuthButton AuthButton start" data-cms-ai="0" data-size="small"
                                                            onclick='
                                                    ...
                                                    <bsp-auth-button>
                                                        <a class="JoinAuthButton AuthButton start1" data-cms-ai="0" data-size="small"
                                                            onclick='
                                        ...
                                        <a class="Button" data-size="small" href="{{url('investment')}}"
                                            data-cms-ai="0">View Details</a>
                ...
                <div class="PageList-footer" data-auth-type="Join" data-animate="fade">
                    ...
                    <div class="PageList-cta" data-animate="fade">
                        <a class="Button" href="{{url('investment')}}" data-cms-ai="0">
            ...
            <div class="PagePromoModuleC" data-module data-align-left>

                <div class="PagePromoModuleC-content">
                    <div class="PagePromo-title" data-animate="fade">
                        Steady monthly rental income may make real estate an ideal cash-flow investment
                    </div>

                    <div class="PagePromo-description" data-animate="fade">
                        The potential production of steady monthly rental income can make real estate an ideal cash-flow
                        investment.
                    </div>

                    <div class="PagePromo-byline" data-animate="fade">
                        <div class="PagePromo-date">July 07, 2022 08:29 AM</div>
                    </div>
                ...
                <div class="PagePromoModuleC-mediaSection" data-animate="fade">
                    ...
                    <div class="PagePromoModuleC-customToken"><span class="pre-symbol">$</span><span
                            class="PagePromoModuleC-customToken-text">5.7</span><span
                            class="post-symbol">BN</span>
                    </div>


                    <div class="PagePromoModuleC-extraText">
                        <span>PROPERTY VALUE FINANCED VIA THE PropEstateHoldings PLATFORM</span>
                    </div>
                ...
                <div class="PagePromoModuleC-mobileButton">
                    ...
                    <div class="PagePromo-button" data-auth-type="Join" data-animate="fade">
                        ...
                        <a class="Button" data-size="default" href="{{url('investment')}}" data-cms-ai="0">View
                            investments</a>
            ...
            <div class="PagePromoModuleL" data-align-right data-has-background
                style="--color-module-background:#f2f2f2;  --opacityOverlay: 0%;" data-image-position="right">

                <a class="AnchorLink" id="a-strategy-to-grow-wealth" name="a-strategy-to-grow-wealth"
                    data-cms-ai="0"></a>
                ...
                <div class="PagePromo-media"><span class="Link">
                        <picture>
                            <source type="image/webp" width="1440" height="810"
                                srcset="./assets/images/strategy.png 1x,./assets/images/strategy.png 2x" />

                            <source width="1440" height="810"
                                srcset="assets/images/strategy.png" />

                            <img class="Image" data-image-size="xl-16x9" alt="img_panel_growth.75fd4fc7.jpg"
                ...
                <div class="PagePromoModuleL-content-wrapper">
                    <div class="PagePromoModuleL-content">
                        ...
                        <div class="PagePromo-description" data-animate="fade">
                            A traditional growth strategy leverages investments that may increase in value over the long
                            haul. For buy-and-hold real estate investors, this means investing in properties with
                            potential for appreciation, with the intention of profiting at the time of sale.
                            Additionally, ideal properties may even offer quarterly distributions over the course of
                            ownership.<br><br>
                        </div>
            ...
            <div class="PageListStandardV" data-module data-has-background style="--color-module-background:#f8f8f8;" data-column-count="2">

                <a class="AnchorLink" id="meet-the-reits" name="meet-the-reits" data-cms-ai="0"></a>
                <div class="PageList-header" data-auth-type="Join">
                    <div class="PageList-header-title" data-animate="fade">Growth Opportunities Available Today</div>
                </div>
                <div class="PageList-items">
                    <div class="PageList-items-item">
                        <div class="PagePromoA" data-is-complete="false">
                            <div class="PagePromoA-container">
                                <div class="PagePromoA-top">
                                    ...
                                    <div class="PagePromoA-image">
                                        <a class="Link" aria-label="THE APARTMENT GROWTH REIT"
                                            href="{{url('investment')}}" data-cms-ai="0">
                                            <picture>

                                                <source type="image/webp" width="1000" height="563"
                                                    srcset="./assets/images/growth.png 1x,./assets/images/growth.png 2x" />

                                                <source width="1000" height="563"
                                                    srcset="assets/images/growth.png" />

                                                <img class="Image" data-image-size="large-16x9" alt="MRII.bd339c86.jpg"
                                                    width="1000" height="563"
                                                    srcset="./assets/images/growth.png 1x,./assets/images/growth.png 2x"
                                ...
                                <div class="PagePromoA-bottom">
                                        ...
                                        <div>
                                            ...
                                            <bsp-tooltip class="Tooltip">
                                                ...
                                                <template style="display: none;">
                                                    ...
                                                    <div class="Tooltip-body">The PropEstateHoldings Apartment Growth REIT has
                                                        consistently declared distributions on a quarterly basis since
                                                        it started its operation. All distributions equate to
                                                        approximately 4.50% (net of fees) on an annualized basis based
                                                        upon Purchase Price as of 01/01/18. The annualized distribution
                                                        rate is not a guarantee or projection of future distributions
                                                        and may be modified at the REIT's discretion.</div>
                                    ...
                                    <div class="PagePromoA-blurb-container">
                                        ...
                                        <div class="PagePromoA-blurb">
                                            A Real Estate Investment Trust with the objectives to realize capital
                                            appreciation in the value of our investments over the long term; and to pay
                                            attractive and stable cash distributions to stockholders.
                                        </div>
            ...
            <div class="PagePromoModuleE" data-align-left data-has-disclosure data-image-position="left">

                <a class="AnchorLink" id="see-how-real-estate-can-help-achieve-growth-goals"
                    name="see-how-real-estate-can-help-achieve-growth-goals" data-cms-ai="0"></a>
                ...
                <div class="PagePromoModuleE-mediaSection">
                    ...
                    <div class="PagePromo-media"><a class="Link" aria-label="Real estate can help achieve growth goals"
                            href="{{url('investment')}}" data-cms-ai="0">
                            <picture>
                                <source type="image/webp" width="1000" height="563"
                                    srcset="./assets/images/chart.png 1x,./assets/images/chart.png 2x" />

                                <source width="1000" height="563"
                                    srcset="assets/images/chart.png" />
                    ...
                    <div class="PagePromoModuleE-disclosureLink">
                        <bsp-disclosure-link><a class="disclosureModalLink" data-cms-ai="0">Disclosure</a>
                        </bsp-disclosure-link>
                    </div>

                    <div class="PagePromoModuleE-disclosureDescription">
                        Bloomberg Barclays US Aggregate Bond TR USD data source from MorningStar
                ...
                <div class="PagePromoModuleE-content">
                    ...
                    <div class="PagePromo-description" data-animate="fade">
                        With potentially lower volatility than the stock market and higher historic long-term gains,
                        real estate investing can be attractive to growth investors. In select investments offered on
                        the PropEstateHoldings platform, distributions can be reinvested to leverage the potential of compound
                        interest.<br><br>
                    </div>
                    <div class="PagePromo-button" data-auth-type="Join" data-animate="fade">
            ...
            <div class="PagePromoModuleL" data-has-background
                ...
                <a class="AnchorLink" id="create-a-diversified-portfolio" name="create-a-diversified-portfolio"
                    data-cms-ai="0"></a>
                <div class="PagePromo-media"><span class="Link">
                    <picture>
                        <source type="image/webp" width="1000" height="563"
                            srcset="./assets/images/2.png 1x,./assets/images/2.png 2x" />

                        <source width="1000" height="563"
                            srcset="assets/images/2.png" />
                ...
                <div class="PagePromoModuleL-content-wrapper">
                    <div class="PagePromoModuleL-content">
                        ...
                        <div class="PagePromo-description" data-animate="fade">
                            Many investors believe that they are protected against public market volatility since their
                            portfolio includes a range of asset classes, such as stocks and bonds. However, to achieve
                            genuine diversification, investors may consider adding primary alternatives like real
                            estate. PropEstateHoldings offers both real estate investment trusts (REITs) and private placement
                            deals — assets not traded on--nor tied to--the stock market.<br><br>
                        </div>
            ...
            <div class="PageListStandardV" data-module data-has-background style="--color-module-background:#f8f8f8;"
                ...
                <div class="PageList-header" data-auth-type="Join">
                    ...
                    <div class="PageList-header-title" data-animate="fade">Diversification Opportunities Available Today
                    </div>
    ...
    @media only screen and (min-width: 801px) {
        ...
        .start1 {
            ...
            <div class="PagePromoModuleE" data-align-left data-has-disclosure data-image-position="left">
                ...
                <a class="AnchorLink" id="what-does-a-diversified-portfolio-look-like"
                    name="what-does-a-diversified-portfolio-look-like" data-cms-ai="0"></a>
                ...
                <div class="PagePromoModuleE-mediaSection">
                    ...
                    <div class="PagePromo-media"><a class="Link"
                            aria-label="What does a diversified portfolio look like?"
                            href="{{url('investment')}}" data-cms-ai="0">
                            <picture>
                                <source type="image/webp" width="1000" height="563"
                                    srcset="./assets/images/3.png 1x,./assets/images/3.png 2x" />

                                <source width="1000" height="563"
                                    srcset="./assets/images/3.png" />
                    ...
                    <div class="PagePromoModuleE-extraText">
                        <span>EFFICIENT FRONTIER: TRADITIONAL INVESTMENTS WITH &amp; WITHOUT ALTERNATIVES</span>
                    </div>
                    ...
                    <div class="PagePromoModuleE-disclosureDescription">
                        Based on the returns of the S&amp;P 500 Index, Barclays U.S. Aggregate Bond Index, and the
                        NCREIF (National Council of Real Estate Investment Fiduciaries) Index, and with and without an
                        asset allocation to direct real estate, over an 11-year time period (2006-2016).

                        Each index provides a broad representation of a particular asset class and is not indicative of
                        any investment or a projection of performance. Asset allocation does not ensure a profit or
                        protect against a loss. The rates of returns shown do not reflect the deduction of fees and
                ...
                <div class="PagePromoModuleE-content">
                    ...
                    <div class="PagePromo-description" data-animate="fade">
                        There are a variety of methods investors may use to determine their ideal portfolio allocation.
                        But too often portfolios leave out an important asset class – commercial real estate. While the
                        appropriate allocation of CRE will vary by investor based on their age, financial goals, or
                        income, real estate is an important part of a diversified portfolio.
                    </div>
            ...
            <bsp-list-loadmore data-module class="PageListStandardB" data-hide-descriptions="true" data-has-background
                style="--color-module-background:#f2f2f2;">




                <a class="AnchorLink" id="gain-new-investing-insight" name="gain-new-investing-insight"
                    data-cms-ai="0"></a>
                ...
                <div class="PageList-items" data-list-loadmore-items>
                    ...
                    <div class="PageList-items-item">
                        ...
                        <div class="PagePromo" data-align-top>
                            ...
                            <div class="PagePromo-type" data-animate="fade">
                                Article
                            </div>
                            ...
                            <div class="PagePromo-media"><a class="Link"
                                    aria-label="How Your Investment Portfolio Could Benefit from Commercial Real Estate"
                                    href="#"
                                    data-cms-ai="0">
                                    <picture>
                                        <source type="image/webp" width="1000" height="563"
                                            srcset="./assets/images/5.png 1x,./assets/images/5.png 2x" />
                            ...
                            <div class="PagePromo-content">
                                ...
                                <div class="PagePromo-description" data-animate="fade">
                                    When it comes to building a successful investment portfolio, there’s no
                                    one-size-fits-all strategy. For many investors, even high net-worth individuals,
                                    real estate is often an underrepresented portfolio asset.
                                </div>
                                ...
                                <div class="PagePromo-ctaLink" data-animate="fade">
                                    <!--<a href="knowledge-center/article/how-your-investment-portfolio-could-benefit-commercial-real-estate.html"-->
                                    <!--    data-cms-ai="0">-->
                                    <!--    Read More-->
                                    <!--    <svg class="ctaArrow">-->
                    ...
                    <div class="PageList-items-item">
                        <div class="PagePromo" data-align-top>
                            ...
                            <div class="PagePromo-media"><a class="Link"
                                    aria-label="Investing for Beginners: 5 Reasons to Consider Passive Income Investing"
                                    href="#"
                                    data-cms-ai="0">
                                    <picture>
                                        <source type="image/webp" width="1000" height="563"
                                            srcset="./assets/images/6.png 1x,./assets/images/6.png 2x" />
        
                                        <source width="1000" height="563"
                                            srcset="assets/images/6.png" />
                            ...
                            <div class="PagePromo-content">
                                <div class="PagePromo-category" data-animate="fade">
                                    ...
                                    <!--<a class="Link" href="passive-income-1.html" data-cms-ai="0">Passive Income</a>-->
                                ...
                                <div class="PagePromo-description" data-animate="fade">
                                    Many people conflate the concepts of real estate investing and passive income. Real
                                    estate can be a form of passive investing, but often not in the ways that investors
                                    think.
                                </div>
                                <div class="PagePromo-ctaLink" data-animate="fade">
                                    <!--<a href="knowledge-center/article/investing-beginners-5-reasons-consider-passive-income-investing.html"-->
                                    <!--    data-cms-ai="0">-->
                                    <!--    Read More-->
                                    <!--    <svg class="ctaArrow">-->
                                    <!--        <use xlink:href="#chevron-down"></use>-->
