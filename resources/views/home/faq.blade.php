...
<head>
    ...
    <meta property="og:site_name" content="Propestateholdings">
...
body {
  ...
  --font-2: "superior-title";
        ...
        <link data-cssvarsponyfill="true" class="Webpack-css" rel="stylesheet" href="https://realtymogul.brightspotgocdn.com/resource/00000191-c9b6-d554-a5df-d9ff04b60000/styles/default/All.min.6ea1618c43082fa45564bd0aaa7129e3.gz.css">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5"><title>Propestateholdings.com™ | Real Estate Crowdfunding &amp; Investing</title><meta name="description" content="Propestateholdings simplifies commercial real estate investing, giving our members access to vetted commercial real estate opportunities with the potential to generate passive income."><link rel="canonical" href="{{url('faq')}}"><meta name="brightspot.contentId" content="00000181-b574-d68c-addb-b77f38060001"><link rel="apple-touch-icon"sizes="180x180"href="/apple-touch-icon.png"><link rel="icon"type="image/png"href="/favicon-32x32.png"><link rel="icon"type="image/png"href="/favicon-16x16.png"><link type="application/rss+xml" rel="alternate" title="Propestateholdings.com™ | Real Estate Crowdfunding & Investing" href="">

    <!-- this will add webcomponent polyfills based on browsers. As of 04/29/21 still needed for IE11 and Safari -->
    <script src="https://realtymogul.brightspotgocdn.com/resource/00000191-c9b6-d554-a5df-d9ff04b60000/webcomponents-loader/webcomponents-loader.2938a610ca02c611209b1a5ba2884385.gz.js"></script>
    ...
    <script>
        ...
        */
        ...
        if (!window.CSS || !window.CSS.supports || !window.CSS.supports('--fake-var', 0)) {
            ...
            script.setAttribute('src', "https://realtymogul.brightspotgocdn.com/resource/00000191-c9b6-d554-a5df-d9ff04b60000/util/IEPolyfills.61ffd50b8a0fa44f8f77414498fca544.gz.js");
        ...
        <script src="https://realtymogul.brightspotgocdn.com/resource/00000191-c9b6-d554-a5df-d9ff04b60000/styles/default/All.min.5bfa99aa733cbbe02bcf2aa729f4322a.gz.js" async></script>
...
@include('home.header')
    ...
    <div class="Page-content" style="min-height: 100vh">
            ...
            <main class="Page-oneColumn" data-modulewell><div class="OneColumnContainer" data-module data-has-background style="--color-module-background:#f8f8f8;" data-heading-text-align="center">
    
    <a class="AnchorLink" id="frequently-asked-questions" name="frequently-asked-questions" data-cms-ai="0"></a>
    ...
    <div class="OneColumnContainer-container" data-modulewell>
            ...
            <bsp-faq-moduled class="FaqModuleD" >
    <div class="FaqModuleD-container">
        
            <div class="FaqModuleD-header">
                <div class="FaqModuleD-header-title">
                    <svg class="icon">
                        <use xlink:href="#chevron-down"></use>
                    </svg>
                    ABOUT Propestateholdings
                </div>
                
            </div>
        

        <div class="FaqModuleD-items"><bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is Propestateholdings?</p></span>
            <svg class="icon-plus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings empowers members to build a diversified real estate portfolio by providing a secure website and online tools to evaluate potential commercial real estate transactions offered by various real estate companies. Members can assess whether investment opportunities meet their investing goals and risk profile, and then sign legal documents securely online.</p><p>Deals only make it onto the platform after a formalized process to evaluate both the sponsor and the deal is performed by our affiliated broker-dealer, RM Securities.</p><p>After a member makes an investment, they have access to a member dashboard, that provides 24/7 access to their investments along with regular reporting provided by the real estate companies on the performance of these investments. Please note, Propestateholdings and its affiliates do not provide investment advice to members, and members must conduct their own evaluation and due diligence of prospective real estate investments. We strongly advise that you seek advice from an investment professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What are the benefits of using the Propestateholdings platform?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings’s platform provides the software, tools and information that empower members to independently invest in commercial real estate. The platform provides the tools for accredited investors to independently diversify their portfolio with a variety of commercial debt and equity investments offered by numerous real estate companies. The platform enables members to build their own personal real estate portfolio. Members can sort through opportunities presented on the platform, review detailed information provided by the real estate companies and review the performance of past investments.</p><p>Our affiliated broker-dealer, RM Securities performs extensive due diligence on the sponsor, the business plan and the property before a deal is offered on the platform.</p><p>The Propestateholdings platform’s technology and software make the process frictionless, allowing you to screen investments online, sign legal documents online, and have access to all of your documents in one place on your member dashboard.</p><p>Please note, Propestateholdings and its affiliates do not provide investment advice to members, and members must conduct their own evaluation and due diligence of prospective real estate investments. We strongly advise that you seek advice from an investment professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What types of investment opportunities do real estate companies offer using the Propestateholdings platform?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings’s platform is utilized by a wide variety of real estate companies (also known as “Sponsors”) that offer commercial real estate projects throughout the United States.</p><p>Individual deals that have been presented on the platform by Sponsors include:</p><p>· Apartment buildings</p><p>· Office</p><p>· Retail</p><p>· Industrial</p><p>· Mixed-use</p><p>· Ground-up development</p><p>· Self-storage</p><p>· Cold storage</p><p>· Mobile home parks</p><p>Propestateholdings members can also invest in two non-traded Real Estate Investment Trusts (REITs) that give them access to a portfolio of properties that have the potential to pay passive income.</p><p>To find out more about the Propestateholdings REITs, please <span class="LinkEnhancement"><a class="Link"
             href="" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How long has Propestateholdings been in business?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings was founded in 2012.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What’s Propestateholdings’s track record?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>To see the track record of investments made on the Propestateholdings platform, please <span class="LinkEnhancement"><a class="Link"
             href="#" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span><br>To see a list of individual past investments, please <span class="LinkEnhancement"><a class="Link"
             href="{{url('past-investment')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p><p>Please note that past performance is not indicative of future results and should not be used as a basis for an investor’s decision to invest. Investments made on the Propestateholdings platform prior to 4/17/2024 were not offered by RM Securities, LLC and should not be viewed as indicative of or attributable to any performance related to the investment products or services offered by RM Securities, LLC, nor should you assume that any products or services offered by RM Securities, LLC will in the future will be profitable or equal to any performance of cumulative or specific past investments made on the Propestateholdings platform.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Who is your CEO? And what’s his or her background?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Jilliene Helman is the founder and CEO of Propestateholdings.</p><p>After graduating from Georgetown University with a degree in International Business and Management, Jilliene worked extensively in the wealth management sector in the United States and in Asia, eventually becoming a Vice President at Union Bank in Los Angeles.</p><p>Jilliene is a Certified Wealth Strategist and has been featured as an expert on startups and real estate investing on Bloomberg, CNBC, The New York Times, Yahoo! Finance and Entrepreneur.</p><p>In addition to real estate ventures, Jilliene sits on the Board of Directors of NextHealth, a health optimization center in Los Angeles providing IV therapy, cryotherapy, hormone therapy, stem cells treatments, and state of the art testing and monitoring.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How do I speak to a registered representative about investments?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>At Propestateholdings, all members are assigned to a dedicated licensed investors relations representative. This investor relations representative is available to answer any questions on how the platform works and about specific offerings on the platform.</p><p>Please note that representatives do not provide recommendations or investment advice to members.</p><p>To schedule a meeting, click here</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How much have Propestateholdings members invested on the platform to date?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>To date, over $${totalAmountFinanced} of capital has been invested in real estate projects on the Propestateholdings platform and real estate companies have raised capital to finance ${totalPropertiesFinanced}+ properties valued at over $${totalPropertyValueFinanced}.<sup>1,2</sup></p><p>To view the performance of individual deals that have gone full cycle (in other words, the investments have been completed and all distributions have been paid to members), please see the <span class="LinkEnhancement"><a class="Link"
             href="{{url('past-investment')}}" target="_blank" rel="noopener" data-cms-ai="0">Past Investments</a></span> section of our website.</p><p>As for RealtyMogul’s two Real Estate Investment Trusts (REITs):</p><p>To view the performance of the Income REIT, <span class="LinkEnhancement"><a class="Link"
             href="" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span>.</p><p>To view the performance of the Apartment Growth REIT, <span class="LinkEnhancement"><a class="Link"
             href="" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span>.</p><p>Please note, RealtyMogul does not provide investment advice to members, and members must conduct their own evaluation and due diligence of prospective real estate investments.</p><p>Additionally, investments in real estate are speculative, highly illiquid, and involve substantial risk. You should not invest unless you can sustain the risk of loss of capital, including the risk of total loss of capital. Please carefully review the general platform Disclosures and the specific offering documents for each investment product which contain important information about the fees you will pay, conflicts of interest, and relevant specific and general risks.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Who makes up the Propestateholdings team?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings is a team of professionals with experience in real estate, technology, and finance. To learn more about our executive team, <span class="LinkEnhancement"><a class="Link"
             href="{{url('our-story')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Where is the company located?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings is headquartered in Los Angeles, California</p></div>
</bsp-faq-question>
</div>
    </div>
</bsp-faq-moduled><bsp-faq-moduled class="FaqModuleD" >
    <div class="FaqModuleD-container">
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Are there any minimum qualifications I need to meet to be able to invest?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is an accredited investor?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How does the platform work? How do I invest?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>For a step-by-step walkthrough of how to invest in an individual deal offered by a real estate company (also known as “Sponsor”) on the Propestateholdings platform, or how to invest in the two Propestateholdings REITs, please <span class="LinkEnhancement"><a class="Link"
             href="{{url('our-story')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What type of reporting will I receive after I invest?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Members will be able to view updates regarding their investments when they log in to the Propestateholdings platform and view their member dashboard. This is their hub of information, providing comprehensive metrics about their distributions to date, upcoming milestones, and overall return on investment. Members are notified by email when distributions are sent to their bank account.</p><p>Propestateholdings provides a conduit for all members to receive timely updates from real estate companies at least quarterly. Updates will be provided via email and via the Propestateholdings member dashboard. In addition, members will receive tax documents every year that they have a distribution from a particular real estate investment. All information provided to members will be provided by and approved by the related real estate company.</p><p>Please note that the information provided with respect to a particular private placement is provided by the sponsor of that deal.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Are investment returns guaranteed?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Some offerings on the Propestateholdings platform, including Propestateholdings’s REITs, do accept investments from self-directed IRA accounts but it will depend on your custodian’s processes/procedures. If the transaction permits self-directed IRA account investments, there are two requirements that must be satisfied to permit members to use a self-directed IRA account or other type of retirement account: (1) the custodian must be able to process documents via electronic signatures, and (2) it must be able to process contributions and distributions via ACH transfer payments.</p><p>Unfortunately, some custodians have difficulty meeting these conditions. Please inquire with your current custodian whether they can work with these requirements, and if not, we can refer you to other providers who can meet these <span class="LinkEnhancement"><a class="Link"
             href="#" target="_blank" rel="noopener" data-cms-ai="0">guidelines</a></span>.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Does Propestateholdings offer 1031 exchanges?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>No.</p></div>
</bsp-faq-question>
</div>
    </div>
</bsp-faq-moduled><bsp-faq-moduled class="FaqModuleD" >
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How does an investment opportunity get presented on Propestateholdings platform?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Real estate companies (also known as “Sponsors”) may present their investment opportunities using the Propestateholdings platform after a formalized due diligence review by our affiliated broker-dealer, RM Securities. This review includes RM Securities’ evaluation of the market, the property and the reasonableness of the sponsor’s assumptions regarding the investment.</p><p>RM Securities also reviews the sponsor’s business plan and reviews the key business assumptions for reasonableness based on years of experience and 3<sup>rd</sup> party data sources. The team also reviews the overall market assumptions including population and rent growth along with an evaluation of the sources and uses of capital, with a review of the debt terms and proof of debt commitment.</p><p>Additionally, after the Sponsor’s offering is live on the platform and prior to the closing of a transaction and the release of investor funds from third-party escrow, the RM Securities team engages in additional due diligence that may include personally visiting the property or a representative property (in the case of a fund or portfolio) and the review of qualified third party reports with respect to the property condition for 1031 DST <span class="LinkEnhancement"><a class="Link"
             href="#" target="_blank" rel="noopener" data-cms-ai="0">offerings</a></span>.</p><p>Please note, Propestateholdings does not provide investment advice to members. Investors should conduct their own evaluation and diligence of any prospective investment. We strongly advise that you seek advice from an investment professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What types of properties can I invest in?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings’s platform is utilized by a wide variety of real estate companies (also known as “Sponsors”) that offer commercial real estate projects throughout the United States.</p><p>Individual deals that have been listed on the platform by Sponsors include:</p><p>· Apartment buildings</p><p>· Office</p><p>· Retail</p><p>· Industrial</p><p>· Mixed-use</p><p>· Ground-up development</p><p>· Self-storage</p><p>· Cold storage</p><p>· Mobile home parks</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What’s the minimum investment amount?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The minimum investment is different for each investment but is typically $25,000 or $35,000.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How does the investing process work?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>After you have created an account on the Propestateholdings platform and determined that you want to invest in a particular opportunity, our online software will automate and guide you through the subscription process. You will be able to sign legal documents online and select a bank account to fund your investment with. The investment is not final until all legal documents are signed, and funding has been contributed and cleared.</p><p>When a member makes their investment, the money is held securely by an unaffiliated third-party escrow agent. In order for investor funds to be released from this third-party escrow account to the issuer’s bank account, RM Securities will confirm that certain conditions have been satisfied that typically include, to the extent applicable, (a) confirmation of lender proceeds and loan terms; (b) RM Securities’ satisfactory completion of its due diligence of the sponsor, the deal and the offering, including the receipt and review of certain third-party reports, including, without limitation, environmental reports, appraisals (if applicable), zoning reports (if applicable); proof of adequate insurance relevant to the project and the title policy.</p><p>For a step-by-step walkthrough of how to invest in individual deals offered by a real estate company (also known as “Sponsors”) on the Propestateholdings platform, please <span class="LinkEnhancement"><a class="Link"
             href="{{url('how-it-works')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is a pledge?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Pledging is a process whereby real estate companies take indications of interest from prospective investors in an investment prior to the prospective investor actually funding that transaction. The pledge is non-binding, meaning there is no commitment to invest by creating a pledge.</p><p>Real estate companies using the Propestateholdings platform will notify pledged prospective investors first when a transaction opens for funding. In the event capacity exists after being offered to pledged investors, the real estate company will open the offering to all members.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is a waitlist?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>If an investment reaches full capacity or is otherwise unavailable for investment at that time, the real estate company will move its offering to the Waitlist stage to prevent further pledges or investments. You are welcome to place yourself on the waitlist and should any investment capacity become available in the offering, you will be notified by the real estate company. There is no obligation to invest once notified.</p><p>For a step-by-step walkthrough of how to invest on the Propestateholdings platform, please <span class="LinkEnhancement"><a class="Link"
             href="{{url('how-it-works')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How do I transfer funds into an investment?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Standard ACH transfers can be made from a member’s bank account for amounts up to $100,000 can be made through the platform’s online software. Amounts larger than $100,000 are made using a wire transfer directly to the relevant third-party escrow account.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How will my investment cash flow allocations be distributed?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>For all individual deals offered by real estate companies on the platform, please review the description of that individual investment as provided by the relevant real estate company.</p><p>Distributions are typically sent to the same bank account that was used for your original investment. However, we can accommodate changing a distribution bank account by request. Any changes to a distribution account will require you to prove valid ownership of the new account for compliance purposes. Distributions are never guaranteed in amount or timing, and you should carefully read the offering documents on the specific deal you are interested in to fully understand the projected distributions and what risks are involved.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How often should distributions be expected?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The timing of distributions are governed by the deal documents for the specific investment and are typically at the discretion of the manager of the real estate company. Often, the documents provide that distributions will be made by the sponsor to equity investors each quarter for deals that are cash flowing.</p><p>Please review the expected distribution schedule in the relevant operating agreement and offering documents for each investment before making an investment.</p><p>No distributions are guaranteed as to amount or timing.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How liquid are these investments?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The real estate investments offered by real estate companies on the Propestateholdings are always private transactions in physical properties around the United States and are not traded on public stock exchanges and cannot be easily sold or traded. You should not invest with the expectation of reselling your investment, and we strongly advise that you seek advice from an investment professional, including concerning illiquid investments.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What if I invested in equity and more money is needed for the property in the future? Am I obligated to invest more as an equity owner?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Propestateholdings investments typically do not have mandatory capital calls.</p><p>A capital call is where the investor is required to commit more money to the property, beyond the initial investment. In the event that the sponsor requests additional capital contributions investors will be asked to contribute and if they choose not to for any reason, it is possible that investors will be diluted if more money needs to be raised.</p><p>Please check the offering materials for each investment to fully understand your liabilities as an investor.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What are the general timelines for investment?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Individual deals on the Propestateholdings platform are offered under Rule 506(c) of Regulation D (Reg D) of the Securities and Exchange Commission (SEC) which requires verification of each member’s accredited investor status.</p><p>Additionally, non-accredited members in Propestateholdings’s two REITS will be required to provide certain financial information to ensure that they meet the requirements for investment under Regulation A+.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>As a member, do I have to go through a due diligence process? </p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Prior to making an investment with a real estate company utilizing the Propestateholdings platform, prospective investors are required to answer certain questions and complete know your customer (“KYC”) and anti-money (“AML”) requirements. Our technology will guide you through this process. We do not run credit checks on prospective investors.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How are legal documents handled on the Propestateholdings platform?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>For many transactions, the legal documents can be sent and signed electronically through our platform software. This allows for more efficient and seamless transfer of documents between you and the real estate company offering the investment, while maintaining the authenticity and security of your information. Additionally, some sponsors and transactions require that the legal documents be executed using DocuSign. If this occurs, Propestateholdings will do everything possible to make it an efficient process.</p><p>Investments are finalized once proper legal documentation is accepted, funds are confirmed received, RM Securities has completed its diligence review and you are provided with completed countersignatures.</p></div>
</bsp-faq-question>
</div>
    </div>
</bsp-faq-moduled><bsp-faq-moduled class="FaqModuleD" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>A Real Estate Investment Trust (REIT) is a single investment into a portfolio of real estate properties, which are often diversified by property type, geography, or multiple categories to potentially achieve strategic objectives.</p><p>REITs are legally required to distribute 90% of all taxable income to investors annually.</p><p>Generally, REITs have historically outperformed the broad stock market more often than not when returns are measured in years.<sup>3</sup> REITs have also historically been positively correlated with inflation, which may make them a possible hedge for inflation.<sup>4</sup></p><p><sup>3. </sup><span class="LinkEnhancement"><a class="Link"
             href="https://www.reit.com/news/blog/market-commentary/reit-average--historical-returns-vs-us-stocks" target="_blank" rel="noopener" data-cms-ai="0">https://www.reit.com/news/blog/market-commentary/reit-average--historical-returns-vs-us-stocks</a></span></p><p><sup>4.</sup> <span class="LinkEnhancement"><a class="Link"
             href="https://www.reit.com/news/blog/market-commentary/how-reits-provide-protection-against-inflation" target="_blank" rel="noopener" data-cms-ai="0">https://www.reit.com/news/blog/market-commentary/how-reits-provide-protection-against-inflation</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What’s the difference between the two Propestateholdings REITs?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The main differences are their respective investment strategies. The Propestateholdings Apartment Growth REIT targets investments in multifamily properties that offer value-add opportunities with the potential for value appreciation, while the Propestateholdings Income REIT targets investments in properties of all asset types with the goal of generating consistent cash distributions.</p><p>In short, the Propestateholdings Apartment Growth REIT is focused on growth investments while the RealtyMogul Income REIT is more focused on income-producing investments.</p><p>To learn more about the RealtyMogul REITs <span class="LinkEnhancement"><a class="Link"
             href="{{url('why-reit')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The minimum investment is $5,000 and investors may invest additional capital at a minimum of $1,000 directly or through a Self-Directed IRA (“SDIRA”)<sup>3</sup> or with a Registered Investment Advisor.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How have the REITs performed historically?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>To view the performance of the Income REIT, <span class="LinkEnhancement"><a class="Link"
             href="{{url('why-reit')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p><p>To view the performance of the Apartment Growth REIT, <span class="LinkEnhancement"><a class="Link"
             href="{{url('why-reit')}}" target="_blank" rel="noopener" data-cms-ai="0">click here</a></span></p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Non-traded REITs, such as the RealtyMogul REITs, are not liquid investments, which means you may think of an investment in the REITs as a long-term investment into real estate. Each REIT has, however, adopted a Share Repurchase Program whereby each REIT alone may purchase shares back from investors. The Share Repurchase Program is designed to provide the REITs’ shareholders with limited liquidity for their investment in REIT shares, subject to availability of capital.</p><p>As is more thoroughly discussed in the Share Repurchase Program section of each REIT’s Offering Circular, after 12 months of ownership, your shares may be repurchased at the most recently announced NAV per share multiplied by the Effective Repurchase Rate, which may discount the amount you receive for your repurchased shares based on how long the shares have been held.</p><p>The Effective Repurchase Rate is based on the stock purchase anniversary as follows:<br></p><table border="1" cellpadding="0" cellspacing="0" style="color: rgb(0, 0, 0); font-family: &quot;Gotham SSm A&quot;, &quot;Gotham SSm B&quot;, Helvetica, Arial, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><tbody><tr><td colspan="1" rowspan="1" class="rtecenter">Share Repurchase Anniversary (Year)</td><td colspan="1" rowspan="1" class="rtecenter">Effective Repurchase Rate<sup>(1)</sup></td></tr><tr><td colspan="1" rowspan="1">Less than 1 year</td><td colspan="1" rowspan="1">(Lock-up) 0%</td></tr><tr><td colspan="1" rowspan="1">1 year until 2 years</td><td colspan="1" rowspan="1">98%</td></tr><tr><td colspan="1" rowspan="1">2 years until 3 years</td><td colspan="1" rowspan="1">99%</td></tr><tr><td colspan="1" rowspan="1">3 or more years</td><td colspan="1" rowspan="1">100%</td></tr><tr><td colspan="1" rowspan="1">Death (Exception Repurchases)</td><td colspan="1" rowspan="1">100%</td></tr></tbody></table><p>(1) As a percentage of the Repurchase Base Price per share. The repurchase price will be rounded down to the nearest $0.01.</p><p>For additional details regarding the Repurchase Program, please see each REITs’ respective Offering Circular.</p><p>You should not invest with the expectation of reselling your investment.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Joining Propestateholdings and using the platform is free and members who choose to invest with the Propestateholdings REITs will not be required to directly pay any fee. However, there are fees that investors directly or indirectly pay in connection with each investment. As we are big believers in transparency, you can find the specific fee structure for each real estate investment opportunity as a standard disclosure on the Propestateholdings platform. Please see the Offering Circulars for all fees related to investments in the REITs.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Who manages the two Propestateholdings REITs?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The Propestateholdings Income REIT and the Propestateholdings Apartment Growth REIT are managed by RM Adviser, LLC, a SEC-registered investment adviser and wholly owned subsidiary of Propestateholdings, Co.</p><p>RM Adviser, which manages both of the REITs’ day-to-day operations, has access to the experienced team of real estate finance professionals employed by Propestateholdings, Co., including Jilliene Helman, its Chief Executive Officer.</p><p>As the Manager, RM Adviser, LLC performs the following services for the Income REIT: investment advisory and acquisition services (including performing due diligence on the Propestateholdings Income REIT’s investments), offering services, asset management services, accounting and other administrative services, shareholder services, financing services, and disposition services.</p><p>Although the Manager, RM Adviser, LLC, manages the day-to-day operations, the Apartment Growth REIT operates under the direction of its Board of Directors, a majority of whom are independent directors. Flynann Janisse has served as an independent director of the Apartment Growth REIT since July 2017. She has several decades of experience in asset management with an emphasis on the development and implementation of social services programs for service-enriched affordable housing. She currently serves as Executive Director of Rainbow Housing Assistance Corporation, President and Executive Director of Equality Community Housing Corporation, and President and Chairman of the Board of Rainbow Housing Texas, Inc.</p><p>Louis S Weeks III has served as an independent director of the Apartment Growth REIT since July 2017. He has been involved in commercial real estate and finance for more than 35 years, most recently as Founder and Principal of SeaburyCoxe Advisors, LLC, which consults in financing and investing for commercial real estate projects nationwide.</p></div>
</bsp-faq-question>
</div>
    </div>
</bsp-faq-moduled><bsp-faq-moduled class="FaqModuleD" >
    ...
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What type of tax documentation will I get for each investment?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The real estate companies, also known as “Sponsors,” that offer individual deals on the Propestateholdings platform issue K-1s to their investors. We highly encourage Sponsors to deliver K-1s in time for a standard April 15th tax filing deadline. These K-1s will be posted to your Propestateholdings dashboard.</p><p>Investors in the two Propestateholdings Real Estate Investment Trusts will be issued 1099s. 1099s arrive at the end of January for the previous tax year. 1099s will also be posted to your Propestateholdings dashboard.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is Form 1099-DIV?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The form IRS Form 1099-DIV: Dividends and Distributions is sent to Real Estate Investment Trust (REIT) investors annually and used to report dividends earned and capital gains distributions paid during the tax year. The Propestateholdings REIT that sent you a distribution will be identified in the top-left box of the form.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Why have I received a Form 1099-DIV?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>You received a Form 1099-DIV because you were paid dividends from one or more of your investments in the Propestateholdings Income REIT or the Propestateholdings Apartment Growth REIT. For you to properly report these distributions to the IRS, Form 1099-DIV shows the type of income from distributions you received. The Propestateholdings REIT that sent you a distribution will be identified in the top-left box of the form.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is the difference between the distributions shown in Boxes 1a, and Box 3 in Form 1099-DIV?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Form 1099-DIV shows your ordinary dividends in Box 1a and non-dividend distributions in box 3.</p><p>Each year, we are required to report to you the type of income for distributions paid to you, which is determined by comparing the amount of distributions paid by each Real Estate Investment Trust (REIT) with the REIT’s earnings and profits for a given year. The REIT’s calculated current and accumulated earnings and profits is the result of a tax calculation, which often differs from the REIT’s profits calculated in accordance with generally accepted accounting principles and presented to you in such REIT’s Annual Report on Form 1-K each year.</p><p>In the event that any portion of distributions paid to you exceeds earnings and profits in a given year for the Income REIT or the Apartment Growth REIT, it is treated as a non-dividend distribution, also referred to as a return of capital. Distributions that do not exceed the calculated current and accumulated earnings and profits are reflected as ordinary dividends.</p><p>In general, ordinary distributions (Box 1a) are taxed currently; non-dividend distributions (Box 3), or returns of capital, reduce cost basis or the original purchase value of your shares. In the event aggregate returns of capital received exceeds your original cost basis, then the excess is recognized as a capital gain for the year in which it is received. Therefore, you can adjust the cost basis of your investment each year based on the amount shown in Box 3 “non-dividend distributions” on your Form 1099-DIV. By tracking adjustments to your cost basis each year, you can properly report any gain or loss you experience on the disposition or redemption of your shares.</p><p>When you sell your shares, the difference between your adjusted cost basis and final net sale price will be taxable as a capital gain or loss on your tax return. Keeping track of your adjusted cost basis each year can be helpful when you finally sell your investment. Please consult your tax advisor if you need assistance with the calculation of your cost basis or if you have other questions regarding the reporting of distributions that you received.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is Box 5 Section 199A in Form 1099-DIV, and why is it the same as Box 1a?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>If you received any dividends from the REITs, this will be reflected in Box 5 Section 199A dividends. This reports your qualified REIT income and allows a 20% deduction for pass-through businesses and was created by the 2017 Tax Cuts and Jobs Act. All of the Income REIT’s dividends were categorized as qualified REIT dividends, which is why Box 5 and Box 1a are the same.</p><p>If your taxable income exceeds $315,000 as a married couple filing a joint return, or $157,000 as any other type of taxpayer, the deduction can be subject to additional limitations. Please consult your tax advisor for more information about these limitations.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is Form 8937 and where can I obtain a copy of the most recent one?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>A qualified dividend is a type of dividend which may be subject to preferential tax rates, which are typically lower than regular income tax rates. Non-qualified, ordinary dividends are taxed at the normal rate based on your ordinary income. Based on the historical operations of our REITs, all dividends issued by our REITs are not qualified. If the REITs pay qualified dividends, we will report them in Box 1b.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional. A qualified dividend is a type of dividend which may be subject to preferential tax rates, which are typically lower than regular income tax rates. Non-qualified, ordinary dividends are taxed at the normal rate based on your ordinary income. Based on the historical operations of our REITs, all dividends issued by our REITs are not qualified. If the REITs pay qualified dividends, we will report them in Box 1b.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is Form 1099-INT?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>Form 1099-INT is used to report income from interest above $10 during the tax year.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Why have I received Form 1099-INT for my Propestateholdings investment?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>If you have invested in any individual deals that were structured as debt investments, you are considered a lender. The dividends that you received due to the debt investments included interest payments, which are considered taxable income. Propestateholdings is required to file Form 1099-INT on interest over $10 paid during the tax year.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>What is a K-1?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>If you invested in Private Offerings or individual deals, you would receive a Schedule K-1, K-1 information, or substitute K-1 (collectively referred to as a K-1).</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>When will K-1s be available to members?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The real estate company or “Sponsor” of each individual deal is responsible for preparing K-1s for investors. Generally, we recommend that all K-1s are sent to investors by March 15 of each year, however, you may be required to obtain one or more extensions for filing federal, state and local tax returns if the Sponsor is unable to produce the K-1 in time.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Should I request an extension for filing my tax returns if I have invested in a Private Offering?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>While we recommend each real estate company or “Sponsor” send out K-1s by March 15 of each year, due to the complexity of these forms, we cannot guarantee that all K-1s will be received prior to tax deadlines. We do recommend that you discuss filing tax extensions with your tax advisor.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>Where do I report the information contained in my K-1?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>The information provided to each investor on his or her K-1 is included on the investor’s federal tax return. Typically, an investor must also file state tax returns in the states in which the Private Offering owns property. In some cases, a composite tax filing may eliminate the need for an investor to file at the state level. Please consult with your tax advisor for more information.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>How does a K-1 differ from a Form 1099-DIV?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>No, the real estate company or “Sponsor” will submit a Form 1065 to the IRS that will include a copy of each individual investor’s K-1.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
<bsp-faq-question class="FaqQuestion" >
    
    <div class="FaqQuestion-header" aria-role="button" role="button">
        <div class="FaqQuestion-title">
            <span><p>If a Private Offering suffers a loss, can I claim that loss as a deduction on my individual tax return?</p></span>
            <svg class="icon-plus">
                <use xlink:href="#icon-plus"></use>
            </svg>
            <svg class="icon-minus">
...
<bsp-faq-question class="FaqQuestion" >
    ...
    <div class="FaqQuestion-answer RichTextBody"><p>This depends on your state of residence.</p><p>Circumstances may vary if you have additional partnership income, expect to receive other K-1s, or in other circumstances. Please consult your tax advisor, CPA, or financial planner for specific guidance.</p><p>Please note that Propestateholdings does not provide tax advice. We strongly encourage you to seek advice from a tax professional.</p></div>
</bsp-faq-question>
</div>
    </div>
</bsp-faq-moduled>
...
<div class="PagePromoModuleO" data-module 


>
    
    <a class="AnchorLink" id="disclaimers" name="disclaimers" data-cms-ai="0"></a>


    
        <div class="PageList-header-title" data-animate="fade">Disclaimers</div>
    
    
    
        <div class="PagePromoModuleO-description">
            1 Past performance is not indicative of future results and should not be used as a basis for an investor’s decision to invest. Investments made on the Propestateholdings platform prior to ${brokerDealerLaunchDate} were not offered by RM Securities, LLC and should not be viewed as indicative of or attributable to any performance related to the investment products or services offered by RM Securities, LLC, nor should you assume that any products or services offered by RM Securities, LLC will in the future will be profitable or equal to any performance of cumulative or specific past investments made on the Propestateholdings platform. All information and any calculations used herein is based on information from inception through ${brokerDealerLaunchDate} and subject to the Disclaimers and Defined Terms located on the Track Record Page.<br><br>2 Capital invested includes: (i) common equity investments in real estate companies and funds; (ii) fixed income investments including preferred equity, senior debt, and mezzanine debt in connection with the acquisition or refinance of commercial real estate; (iii) residential debt investments in connection with financing the acquisition, improvement/renovation, and sale of single family homes; and (iii) loans originated for sale which include non-fractionalized loans sold to institutional buyers. Includes capital that has been deployed by, as well as material amounts of committed but undeployed cash held by, affiliated and unaffiliated real estate companies and funds, including cash in real estate funds that has been returned from completed investments. Certain investments are made by Propestateholdings, Co. or its affiliates. This information should not be used as a basis for an investor’s decision to invest. Investment opportunities on the Propestateholdings Platform are speculative and involve substantial risk.<br><br>3 Responses provided herein relating to SDIRA, rollovers or the use of retirement funds from an IRA, is for informational purposes only and should not be misconstrued as a recommendation or advice. Propestateholdings nor any of its affiliates or professionals are considered investment advisory fiduciaries under Title I of the Employee Retirement Income Security Act of 1974 (ERISA). You should consult with your financial advisor(s) and tax professional(s) to obtain specific information regarding costs, fees and other factors to consider in deciding to use or rollover retirement funds.
        </div>
