...
<!-- Mirrored from www.realtymogul.com/apply-for-equity-capital by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Nov 2022 01:03:01 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>PropertiesInvestmentProgram.com™ | Apply for Equity Capital</title>
    ...
    <script type="text/javascript" defer
        src="../static.zdassets.com/ekr/snippeta6cd.js?key=f0fb7231-d555-4b6c-b382-06ff3c2efb4e"
...
<body class="Page-body">
    ...
    <div class="Page-content" style="min-height: 100vh">
        ...
        <main class="Page-oneColumn" data-modulewell>
            <bsp-form-a class="FormA" data-module data-form-title="Apply for equity capital"
                data-form-id="00000181-d385-d0e6-afbf-f79f997a005a" data-module-padding data-module-margin="none">

                <a class="AnchorLink" id="salesforce-webtolead" name="salesforce-webtolead" data-cms-ai="0"></a>


                <div class="FormA-container">
                    <div class="FormA-main">
                        <div class="FormA-title">Apply for equity capital</div>

                        <div class="FormA-description">Please provide the following information.</div>


                        <form class="FormA-form"
                            action="https://webto.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8"
                            autocomplete="off" method="POST"><input type="hidden" name="oid" value="00DG0000000kX3X">
                            <input type="hidden" name="retURL"
                                value="https://brightspot.realtymogul.com/equity-application/success">
                            <input type="hidden" name="lead_source" value="Web Direct">
                            <input type="hidden" name="brightspot.form.id" value="00000181-d385-d0e6-afbf-f79f997a005a">

                            <div class="FormA-items">
                                <div class="FormA-items-item">
                                    <fieldset class="Fieldset">

                                        <div class="Fieldset-header">

                                            <div class="Fieldset-title">Transaction Information</div>
                                        ...
                                        <div class="Fieldset-items">
                                            ...
                                            <div class="Fieldset-items-item" data-index="1">
                                                <bsp-select class="Select"
                                                    ...
                                                    <label class="Select-label">What is the business purpose of your
                                                        anticipated capital needs?&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>


                                                    <div class="Select-select-wrapper">
                                                        <select class="Select-select" name="00NG000000DffY3" required>

                                                            <option value="" selected>- Select -</option>


                                                            <option value="acquisition-rehab-of-an-existing-asset">
                                                                Acquisition/rehab of an existing asset</option>

                                                            <option value="Ground-up development">Ground-up development
                                                            </option>

                                                            <option value="Recapitalization of owned property">
                                                                Recapitalization of owned property</option>

                                                            <option value="No project identified at this time">No
                                                                project identified at this time</option>

                                                            <option value="Blind or semi-blind fund">Blind or semi-blind
                                                                fund</option>
                                            ...
                                            <div class="Fieldset-items-item" data-index="2">
                                                <bsp-select class="Select"
                                                    ...
                                                    <label class="Select-label">What is the asset type of this
                                                        transaction? Or, what asset type is your firm most experienced
                                                        with?&nbsp;<span class="TextInput-label-required">*</span>
                                                    </label>


                                                    <div class="Select-select-wrapper">
                                                        <select class="Select-select" name="00NG000000Dg613" required>
                                                            ...
                                                            <option value="Single Family Rental/Build to Rent">Single
                                                                Family Rental/Build to Rent</option>

                                                            <option value="Retail">Retail</option>

                                                            <option value="Office">Office</option>

                                                            <option value="Medical/Lab/Tech Office">Medical/Lab/Tech
                                                                Office</option>

                                                            <option value="Industrial/Flex">Industrial/Flex</option>

                                                            <option value="Storage/Self storage">Storage/Self Storage
                                                            </option>
                                            ...
                                            <div class="Fieldset-items-item" data-index="3">
                                                <bsp-fieldset class="FieldsetA-wrapper" data-is-required
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">
                                                    <fieldset class="FieldsetA">

                                                        <div class="FieldsetA-header">
                                                            <div class="FieldsetA-title">Is the transaction located in
                                                                the US?
                                                                <span class="TextInput-label-required">*</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="FieldsetA-items" data-is-radio data-is-radio>



                                                            <div class="FieldsetA-items-item" data-index="1">
                                                                <div class="RadioInput">
                                                                    <label class="RadioInput-label">
                                                                        <input type="radio" name="00NG000000Dfl2D"
                                                                            value="Yes" required>
                                                            ...
                                                            <div class="FieldsetA-items-item" data-index="2">
                                                                <div class="RadioInput">
                                                                    <label class="RadioInput-label">
                                                                        <input type="radio" name="00NG000000Dfl2D"
                                                                            value="No" required>
                                                        ...
                                                        <div class="RadioInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="4">



                                                <bsp-text-input class="TextInput"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">
                                                    <input class="TextInput-input" type="text" placeholder=" "
                                                        aria-label="How much capital are you looking to raise via the RealtyMogul technology platform?"
                                                        name="00N6f00000GHNSg" required>
                                                    <label class="TextInput-label">How much capital are you looking to
                                                        raise via the PropertiesInvestmentProgram technology platform?&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                            ...
                                            <div class="Fieldset-items-item" data-index="5">
                                                <bsp-text-area class="TextArea"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">
                                                    <label class="TextArea-label">Please provide details regarding your
                                                        anticipated Total Capital Stack, including GP equity, Pref
                                                        equity, LP equity, Mez/Senior Debt and any other sources of
                                                        capital. <br>Details:&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <textarea class="TextArea-input" placeholder=" "
                                                        aria-label="Please provide details regarding your anticipated Total Capital Stack, including GP equity, Pref equity, LP equity, Mez/Senior Debt and any other sources of capital. <br>Details:"
                                                        name="00N6f00000GHNSl" required></textarea>
                                                    <div class="TextArea-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="6">
                                                <bsp-select class="Select"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">

                                                    <label class="Select-label">What is the expected cash-on-cash return
                                                        of the project?&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    ...
                                                    <div class="Select-select-wrapper">
                                                        <select class="Select-select" name="00NG000000Dg5Gc" required>
                                            ...
                                            <div class="Fieldset-items-item" data-index="7">
                                                <bsp-select class="Select"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">

                                                    <label class="Select-label">What is the expected investor level IRR
                                                        of the project?&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    ...
                                                    <div class="Select-select-wrapper">
                                                        <select class="Select-select" name="00NG000000Dg5Gb" required>
                                            ...
                                            <div class="Fieldset-items-item" data-index="8">
                                                <bsp-text-area class="TextArea"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">
                                                    <label class="TextArea-label">Please briefly describe the
                                                        transaction you are seeking financing for:&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <textarea class="TextArea-input" placeholder=" "
                                                        aria-label="Please briefly describe the transaction you are seeking financing for:"
                                                        name="00NG000000Dg618" required></textarea>
                                                    <div class="TextArea-errors" aria-live="assertive"></div>
                                ...
                                <div class="FormA-items-item">
                                    <fieldset class="Fieldset">
                                        ...
                                        <div class="Fieldset-header">
                                            ...
                                            <div class="Fieldset-title">Company Information</div>
                                        ...
                                        <div class="Fieldset-items">
                                            ...
                                            <div class="Fieldset-items-item" data-index="1">
                                                <bsp-select class="Select"
                                                    ...
                                                    <label class="Select-label">For acquisition/value-add business
                                                        plans, what is the total value of real estate your company has
                                                        bought and/or sold since inception? <i>(Sale price for realized
                                                            assets, debt + equity for unrealized assets)</i>&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>


                                                    <div class="Select-select-wrapper">
                                                        <select class="Select-select" name="00N6f00000GHNOt" required>
                                                            ...
                                                            <option value="Less than $50 million">Less than $50 million
                                                            </option>

                                                            <option value="$50-$149 million">$50-$149 million</option>

                                                            <option value="$150-$500 million">$150-$500 million</option>
                                            ...
                                            <div class="Fieldset-items-item" data-index="2">
                                                <bsp-select class="Select"
                                                    ...
                                                    <label class="Select-label">For ground-up development business
                                                        plans, what is the total value of real estate your company has
                                                        developed and delivered since inception? (Sale price for
                                                        realized assets, debt + equity for unrealized
                                                        assets):&nbsp;<span class="TextInput-label-required">*</span>
                                                    </label>


                                                    <div class="Select-select-wrapper">
                                                        <select class="Select-select" name="00N6f00000GHNRx" required>
                                                            ...
                                                            <option value="Less than $150 million">Less than $150
                                                                million</option>

                                                            <option value="$150 - $349 million">$150 - $349 million
                                                            </option>

                                                            <option value="$350 - $500 million">$350 - $500 million
                                                            </option>
                                ...
                                <div class="FormA-items-item">
                                    <fieldset class="Fieldset">
                                        ...
                                        <div class="Fieldset-header">
                                            ...
                                            <div class="Fieldset-title">Contact Information</div>
                                        ...
                                        <div class="Fieldset-description">Please provide your contact information</div>
                                        ...
                                        <div class="Fieldset-items">
                                            ...
                                            <div class="Fieldset-items-item" data-index="1">
                                                ...
                                                <bsp-text-input class="TextInput"
                                                    ...
                                                    <label class="TextInput-label">First Name&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <div class="TextInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="2">
                                                ...
                                                <bsp-text-input class="TextInput"
                                                    ...
                                                    <label class="TextInput-label">Last Name&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <div class="TextInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="3">
                                                ...
                                                <bsp-text-input class="TextInput"
                                                    ...
                                                    data-value-missing="This field is required">
                                                    <input class="TextInput-input" type="text" placeholder=" "
                                                        aria-label="Company Name" name="company" required>
                                                    <label class="TextInput-label">Company Name&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <div class="TextInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="4">
                                                ...
                                                <bsp-text-input class="TextInput"
                                                    ...
                                                    data-value-missing="This field is required">
                                                    <input class="TextInput-input" type="text" placeholder=" "
                                                        aria-label="Company City" name="City" required>
                                                    <label class="TextInput-label">Company City&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <div class="TextInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="5">
                                                ...
                                                <bsp-text-input class="TextInput"
                                                    ...
                                                    data-value-missing="This field is required">
                                                    <input class="TextInput-input" type="text" placeholder=" "
                                                        aria-label="Company State" name="State" required>
                                                    <label class="TextInput-label">Company State&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <div class="TextInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="6">
                                                <bsp-email-input class="EmailInput"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required"
                                                    data-type-mismatch="The value entered is not a valid email">
                                                    <label class="EmailInput-label">Email&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                            ...
                                            <div class="Fieldset-items-item" data-index="7">
                                                ...
                                                <bsp-text-input class="TextInput"
                                                    ...
                                                    data-value-missing="This field is required">
                                                    <input class="TextInput-input" type="text" placeholder=" "
                                                        aria-label="Company Website" name="url" required>
                                                    <label class="TextInput-label">Company Website&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <div class="TextInput-errors" aria-live="assertive"></div>
                                            ...
                                            <div class="Fieldset-items-item" data-index="8">
                                                <bsp-phone-number-input class="PhoneNumberInput"
                                                    data-bad-input="The browser is unable to convert your input"
                                                    data-value-missing="This field is required">
                                                    <label class="PhoneNumberInput-label">Phone&nbsp;<span
                                                            class="TextInput-label-required">*</span>
                                                    </label>
                                                    <input class="PhoneNumberInput-input" type="tel" placeholder=" "
                    ...
                    <div class="FormA-divider"></div>

                    <div class="FormA-aside">

                        <div class="FormA-aside-phone-block">
                            <div class="FormA-aside-title">Questions?</div>
                            <div class="FormA-aside-phone-block-item">+1 (510) 255-0413</div>
                        </div>


                        <div class="FormA-aside-solutions-block">
                            <div class="FormA-aside-title">Investment Solutions</div>

                            <div class="FormA-aside-solutions-block-item"><svg class="icon-checkmark-rm">
                                    <use xlink:href="#icon-checkmark-rm"></use>
                                </svg> The PropertiesInvestmentProgram Platform is your source to raise equity capital for real estate
                                deals.</div>

                            <div class="FormA-aside-solutions-block-item"><svg class="icon-checkmark-rm">
                                    <use xlink:href="#icon-checkmark-rm"></use>
                                </svg> Real estate companies typically use the Platform to raise between $5-$20 million
                                of equity.</div>

                            <div class="FormA-aside-solutions-block-item"><svg class="icon-checkmark-rm">
                                    <use xlink:href="#icon-checkmark-rm"></use>
                                </svg> The PropertiesInvestmentProgram Platform is best suited for real estate companies who have
                                invested in at least $200 million of real estate (for development deals, this number is
                                $400 million).</div>

                            <div class="FormA-aside-solutions-block-item"><svg class="icon-checkmark-rm">
                                    <use xlink:href="#icon-checkmark-rm"></use>
                                </svg> The Platform can support multiple property types – from multifamily and mobile
                                home parks, to office and industrial, to retail and self-storage.</div>

                        </div>


                        <div class="FormA-aside-tooltip-block">
                            <div class="FormA-aside-title">Submitting this form will not affect your credit score</div>
                            <div class="FormA-aside-tooltip-block-item"><svg class="security">
                                    <use xlink:href="#security"></use>
                                </svg>
                                <div class="FormA-aside-tooltip-block-label"> This Site is&nbsp;
                                    <bsp-tooltip class="Tooltip">
                                        ...
                                        <template style="display: none;">
                                            ...
                                            <div class="Tooltip-body"><b>Your privacy is protected at all
                                                    times</b><br />
                                                <ul>
                                                    <li><b>256-bit SSL encryption:</b> Encodes information sent online.
                                                    </li>
                                                    <li><b>Firewalls:</b> Firewalls are employed at several points in
                                                        our systems to provide a layered defense of your personal
                                                        information.</li>
                                                    <li><b>System Monitoring:</b> Nonstop protection provides real-time
                                                        alerts about any system changes or attacks.</li>
                                                </ul>
                                            </div>
    ...
    <span data-bsp-pv="b128c3ca-c79e-384b-8fef-1c7ea1730a0d"></span><span
        data-bsp-pv="00000181-d38d-d10c-a7db-f7cd330d0001"></span>
    <script data-bsp-site="00000180-223e-d03c-a7ad-e2fe632f0000"
        data-bsp-contentid="00000181-d38d-d10c-a7db-f7cd330d0001"></script>
</body>

<!-- Mirrored from www.realtymogul.com/apply-for-equity-capital by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Nov 2022 01:03:02 GMT -->
