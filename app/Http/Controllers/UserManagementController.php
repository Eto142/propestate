...
class UserManagementController extends Controller
{
    ...
    public function userProfile($id)
    {
        ...
        return view('manager.user', $data, compact('userProfile', 'userProfit', 'totalBalance', 'totalProfit', 'totalDeposit', 'totalBonus', 'totalEarning', 'totalWithdrawal', 'kyc'));
    }
...
public function DeclineWithdrawal(Request $request, $id)
{
    ...
    public function addUserProfit(Request $request)
    {
        ...
        $transaction->save();
        return redirect()->back()->with('message', 'User Cash Distribution Paid Topped Up Successfully');
    }




    public function addUserEarning(Request $request)
    {
        // $validate->validate($request,[
        //     'subject' => 'required',
        //     'message' => 'required'
        ...
        $transaction->status = 1;
        $transaction->save();
        return redirect()->back()->with('message', 'User Total Distribution Topped Up Successfully');
    }
...
public function ActivateWithdrawal($id)
{
    ...
    return back()->with('status', 'Withdrawal Activated');  
...
public function DeactivateWithdrawal($id)
{
    ...
    return back()->with('status', 'Withdrawal Deactivated');  
